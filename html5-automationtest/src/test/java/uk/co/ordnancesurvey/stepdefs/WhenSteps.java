...
public class WhenSteps {
	...
	public void loginToApplicationAfterLogout(String userName, String Password) throws InterruptedException {
		...
		/*
		 * mainPage.click(obj.Settings); mainPage.click(obj.settings_Login);
		 */
		if (platform.equalsIgnoreCase("Mobile")) {
			mainPage.set_textBox(obj.login_email_address, userName);
			mainPage.set_textBox(obj.login_pwd, Password);
	...
	public void i_Select_the_Route_Type_as(String arg1) throws InterruptedException {
		...
		switch (arg1) {
		case "Cycle":
			mainPage.click(obj.DiscoverRoutes_routeType_Cycle);
			break;
		case "Walk":
			mainPage.click(obj.DiscoverRoutes_routeType_Walk);
			break;
		case "Run":
			mainPage.click(obj.DiscoverRoutes_routeType_Run);
			break;
		case "Other":
			mainPage.click(obj.DiscoverRoutes_routeType_Other);
			break;
		case "All":
			mainPage.click(obj.DiscoverRoutes_routeType_All);
			break;
		}
	...
	public void I_navigate_on_the_home_page_or_try_to_access_functionality_which_is_specific_to_a_registered_user()
			throws Throwable {
		mainPage.click_discoverRoutes();
		driver.findElement(By.xpath(".//*[@id='discoveredRoutesList']/div[1]")).click();
		Thread.sleep(2000);
		assertTrue("Failed: More details link not found on route pop-up",
				driver.findElement(By.xpath(".//*[@id='discPopupContent']/div[5]")).getText().contains("More Details"));
	...
	public void I_navigate_on_the_home_page_or_try_to_access_functionality_which_is_specific_to_a_subscribed_user()
			throws Throwable {
		mainPage.click_discoverRoutes();
		driver.findElement(By.xpath(".//*[@id='discoveredRoutesList']/div[1]")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		assertTrue("Failed: OS getamap subscription link not found on pop-up",
				driver.findElement(By.xpath(".//*[@id='subscription-common-box-products']/div[1]")).getText()
						.contains("£ 19.99"));
	...
	/*
	 * @Author Ravi Kunaparaju Added when steps for POI
	 * 
	 */
