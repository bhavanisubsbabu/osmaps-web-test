...
public class ThenSteps {
	...
	public void i_should_be_able_to_see_side_bar_with_POI_detail_information(String arg1, String arg2, String arg3,
	...
	public void i_should_see_POIs_and_clustered_POIs(String arg1) throws Throwable {
		...
		assertTrue("Failed: Total POIs returned" + total_pois + " doesn't match to expected" + arg1 + " value",
				(Integer.parseInt(arg1) == total_pois));
	...
	// public void i_should_see_the_route_on_the_sidebar(String arg1) throws
	// Throwable {
	//
	// mainPage.clickLinkByXpath(obj.DiscoverRoutes_route_List_FirstRoute);
	// String
	// RouteName=mainPage.getText(obj.DiscoverRoutes_route_List_FirstRoute);
	// assertTrue("The Exepcted Route Name"+arg1+"is not found in side bar
	// Routes First List Item"+RouteName, RouteName.contains(arg1));
	...
	public void i_should_see_the_route_on_the_sidebars(String arg1) throws Throwable {
		...
		assertTrue("The Exepcted Route Name" + arg1 + "is not found in side bar Routes First List Item" + RouteName,
				RouteName.contains(arg1));
		System.out.println(RouteName + "   And" + arg1);
		mainPage.signOUt();
	...
	public void i_should_be_able_to_rate_authored_routes() throws Throwable {
		...
		// assertTrue("The Exepcted ratings"+ ratings +"is not found in side bar
		// ", ratings.contains("(1)"));
	...
	public void i_should_be_able_to_see_A_B_walk_directions() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		// throw new PendingException();
		assertTrue("Failed: A-B route not found, please check manually",
				mainPage.IsElementDisplayed(obj.ab_resultPopup));
	}
	...
	public void i_should_be_given_an_option_to_upgrade_to_a_Registered_user_by_completing_the_registration_process_within_the_application()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void i_should_be_able_to_register_by_completing_the_registration_process_within_the_application()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		mainPage.registernewUser();
		Thread.sleep(2000);
	...
	public void I_should_be_getiing_errors_when_entering_incorrect_details_in_the_registration_process_within_the_application()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void i_should_be_given_an_option_to_upgrade_to_subscribed_user_by_completing_the_subscription_process_within_the_application()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void i_should_be_able_to_upgrade_to_a_subscribed_user_by_completing_the_subscription_process_within_the_application()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void i_should_list_of_clustered_POIs_for_that_location() throws Throwable {
		mainPage.IsElementPresent(obj.POICastelsLondon);

	}

	@Then("^I should see a right side panel view with details$")
	public void i_should_see_a_right_side_panel_view_with_details() throws Throwable {
		mainPage.assertPOI();
	}

	@Then("^I should see POI on map after logging into the application as registered user$")
	public void i_should_see_POI_on_map_after_logging_into_the_application() throws Throwable {
		mainPage.signOUt();
		mainPage.open_login_window();
		mainPage.signIn(AppProperties.get("regUname"), AppProperties.get("regPwd"));
		mainPage.verifyPinOnMap();
	}
	...
	private boolean isRouteAndDirectionBtnVisible() throws Throwable {
		return mainPage.IsElementDisplayed(obj.routeType) && mainPage.IsElementDisplayed(obj.ab_getDirectionBttn);
	}

	@Then("^'Directions' should work as expected$")
	public void directions_should_work_as_expected() throws Throwable {
		assertTrue(isRouteAndDirectionBtnVisible());
	}

	@Then("^'Get Directions' should work as expected$")
	public void get_Directions_should_work_as_expected() throws Throwable {
		assertTrue(isRouteAndDirectionBtnVisible());
	}

	@Then("^'Get me here' link should work as expected$")
	public void get_me_here_link_should_work_as_expected() throws Throwable {
		assertTrue(isRouteAndDirectionBtnVisible());
	}
