@testDisabled
Feature: Verify if user is NOT able to see "Weather" functionality

	Scenario: Check if 'Weather' is NOT available in 'Route Details'
	...
	Scenario: Check if 'Weather' is NOT available in 'Places'
		Given I log into OS maps as a guest/registered/subscribed user
		When I select 'Places' tab in top menu
		Then 'Weather' checkbox in 'Places' panel should NOT be present
	
	Scenario Outline: Check if 'Weather' is NOT available in dropped pin's 'More info'
		Given I log into OS maps as a guest/registered/subscribed user
	...
	Scenario: Check if 'Weather' is NOT available in POI's 'More info'
		Given I log into OS maps as a guest/registered/subscribed user
	...
	Scenario: Check if 'Weather' is NOT available in 'The Places menu' help description
		Given I log into OS maps as a guest/registered/subscribed user
		When I open 'Help'
