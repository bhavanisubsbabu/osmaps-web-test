...
//@Author Ravi Kunaparaju, updated xpath
	...
	// #################################### WhiteLabel + DofE objects ####################################
		...
		public final String helpRoutesMenuTopic = "html/body/div[@class='tooltipster-base tooltipster-default tooltipster-fullscreen tooltipster-fade tooltipster-fade-show']/div[1]/div/div[1]/div[3]/span[starts-with(@class, 'context-help-link') and contains(.,'The Routes menu')]";
		...
		public final String helpPlacesMenuTopic = "html/body/div[@class='tooltipster-base tooltipster-default tooltipster-fullscreen tooltipster-fade tooltipster-fade-show']/div[1]/div/div[1]/div[3]/span[starts-with(@class, 'context-help-link') and contains(.,'The Places menu')]";
		public final String helpDirectionsMenuTopic = "html/body/div[@class='tooltipster-base tooltipster-default tooltipster-fullscreen tooltipster-fade tooltipster-fade-show']/div[1]/div/div[1]/div[3]/span[starts-with(@class, 'context-help-link') and contains(.,'The Directions menu')]";
		public final String helpCreateRouteDescription = "html/body/div[@class='tooltipster-base tooltipster-default tooltipster-fullscreen tooltipster-fade tooltipster-fade-show']/div[1]/div/div[1]/div[3]/span[contains(.,'Create Custom Route:')]";
		public final String helpDiscoverRouteDescription = "html/body/div[@class='tooltipster-base tooltipster-default tooltipster-fullscreen tooltipster-fade tooltipster-fade-show']/div[1]/div/div[1]/div[3]/span[contains(.,'Discover Routes:')]";
